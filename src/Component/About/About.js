  ...
  return (
    <section className="about-page" id="about">
      ...
      <div className="content">
        <p>
          I'm a Self-Taught{" "}
          <span style={{ color: "red" }}>Front-End Developer</span> from Assam,
          highly self-motivated and passionate about learning new things. My
          journey began with a background in Computer Science, having completed
          my MCA from Bangalore. <br />
          <br /> As my proficiency grew, I broadened my expertise to cover
          essential web development technologies such as HTML5, CSS3, and
          JavaScript, while also gaining over 1 year of hands-on experience in
          front-end development, particularly with React.js. This journey into
          front-end development deepened my understanding of client-side
          dynamics, including state management with Redux.
          <br />
          <br id="service" />
          Eager to expand my skill set further, I ventured into backend
          development with Node.js. This exploration allowed me to grasp the
          intricacies of server-side programming and solidify my understanding
      ...
      <div className="tools">
        ...
        <div className="icons">
          ...
          <img src="https://img.icons8.com/color/452/bootstrap.png" />
          <img
